...
class LOGIKA_METERS_4L_EXPORT Spt942: public Logika4L
{
public:
    ...
    Spt942(
        ...
        , const LocString& caption              = LOCALIZED( "СПТ942" )
        , const LocString& description          = LOCALIZED( "тепловычислитель СПТ942" )
