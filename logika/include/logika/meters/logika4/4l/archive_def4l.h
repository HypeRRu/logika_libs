...
struct LOGIKA_METERS_4L_EXPORT ArchiveDef4LSettings: public ArchiveDefSettings
{
public:
...
class LOGIKA_METERS_4L_EXPORT ArchiveDef4L: public ArchiveDef, public SharedConstructible< ArchiveDef4L >
{
public:
