...
class LOGIKA_METERS_EXPORT Spt943rev3: public Logika4M
{
public:
    ...
    Spt943rev3(
        ...
        , const LocString& caption              = L"СПТ943rev3"
        , const LocString& description          = L"тепловычислитель СПТ943 vXX03XX"
