...
struct LOGIKA_METERS_6_EXPORT ArchiveFieldDef6Settings: public ArchiveFieldDefSettings
{
public:
...
class LOGIKA_METERS_6_EXPORT ArchiveFieldDef6: public ArchiveFieldDef
{
public:
